        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
            ...
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img className="d-block w-100 "src="https://m.media-amazon.com/images/I/71NqG9bBp7L._SX3000_.jpg" alt="First slide" />
                </div>
                ...
                <div className="carousel-item">
                    <img className="d-block w-100" src="https://pixosoft.com/images/sliders/pixosoft-slider-3.jpg" alt="Third slide" />
                </div>
            </div>
